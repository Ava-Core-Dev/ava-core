...
- Professional public briefs (volcano / weather) stay free of Ava ops context
...
| Tunnel home | https://ava.rootmc.net/ → redirects status |
...
Sites can embed live CPU / RAM / SOC:

- Script: https://rootrecord.info/ava/assets/powered-by-ava.js
- API: https://ava.rootmc.net/api/powered-by

See also [PUBLIC-APIS.md](./PUBLIC-APIS.md).
