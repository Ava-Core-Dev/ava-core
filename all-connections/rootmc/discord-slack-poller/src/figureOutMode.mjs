...
export function buildFigureOutOpener({ username } = {}) {
  ...
  return [
    ...
    ``,
    `I'm the lead-dev — I help with the game, ideas, bugs, the whole stack. Curious though: what kind of Minecraft are you into? Towny/claims chaos, building, chill survival, PvP, something else?`,
    ``,
