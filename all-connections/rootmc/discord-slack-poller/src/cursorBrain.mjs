...
import { cursorApiKey, AVA_WORKSPACE, AVA_HANDOFF, cursorModelSelection } from "./config.mjs";
 ...
 *
 * @param {{ question: string, context?: string, env?: object, deep?: boolean, images?: any[], surface?: string, selfFix?: boolean, premium?: boolean }} opts
 */
