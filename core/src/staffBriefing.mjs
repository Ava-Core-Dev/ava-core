  ...
  const ranked = [
    {
      ...
      detail:
        "From hihihi6702 feedback. Staged on primary + test (appreciation trim/book strip, spawn safety, shop holograms, rank clarity). Live gate: FileZilla + Shockbyte restart.",
    },
    {
      n: 2,
