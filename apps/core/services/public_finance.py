...
FINANCE_DIRS = [
    ...
    Path("/home/ava-core/ava/data/finance"),
]
# apps/core/services → ava-core-v2 root is parents[3]
GOALS_JSON = (
...
GOALS_JSON_FALLBACKS = [
    Path("/home/ava-core/ava/ava-core-v2/packages/web/avaivy.cloud/src/goals.json"),
    Path("/home/ava-core/ava/data/goals.json"),
]
